...
PRE_FIX_ALIGNMENT_TEXT = (
    ...
    "5 mm bar, and it does not refine away -- on the DEVELOPABLE family, which "
    "is the one the watermark uses: 29.2 -> 64.2 mm bottom and 66.2 -> 102.9 mm "
    "topside from 41 to 161 stations, every one measuring spread 1.000x under a "
    "one-ULP nudge. The constant-x BOTTOM panel at 161 stations is NOT quoted: "
    "it is bistable (24.5 .. 143.8, spread 5.861x) because _trilaterate is "
    "tangential on a planar quad -- see navalai/unroll.py. "
